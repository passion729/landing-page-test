        ...
        <section id="about-us">
            <Container className="flex flex-col md:flex-row gap-10 lg:gap-12 items-center">
                ...
                <div className="w-full md:w-7/12 lg:w-1/2 flex flex-col">
                    ...
                    <Paragraph>
                        We are on a mission to empower businesses with transformative AI technology.
                        Our team of experts combines industry-leading research with innovative algorithms
                        to deliver a platform that adapts to your unique needs. Join us and lead the
                    ...
                    <div className="pt-8 grid grid-cols-1 sm:grid-cols-2 gap-4 max-w-3xl">
                        ...
                        <Info title="Vision" description="Our vision is to f=drive business innovation and grown.">
                            <svg
                                xmlns="http://www.w3.org/2000/svg"
                                width="30"
                                fill="none"
